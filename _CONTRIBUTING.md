...
1. Make commits to your feature branch. Prefix each commit like so:
  ...
  - (test) ...
  - (doc) ...
1. When you've finished with your fix or feature, Rebase upstream changes into your branch. submit a [pull request](https://github.com/Raspy-Dimple/Raspy-Dimple/compare) directly to master. Include a description of your changes.
...
```
git remote add upstream https://github.com/Raspy-Dimple/Raspy-Dimple.git
```
